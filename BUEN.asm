...
.code
.startup
    mov cx, 99       ; inicializo contador en 99 (para mostrar 99-1)

repite:
    mov ax, cx       ; muevo el valor del contador a ax
    call PrintNumber  ; llamo a la subrutina para imprimir el n?mero

    dec cx           ; decremento el contador en uno
    cmp cx, 0        ; compara si en el contador hay un 0
    jne repite       ; si no es igual a 0, regresa a repetir
