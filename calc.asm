...
lee_numero2:
    ...
    ;Si est?? fuera de ese rango, entonces la tecla no fue un car??cter num??rico   
    cmp al,30h          
    jl lee_numero2      ;Si el valor ASCII de la tecla es menor a 30h, no es n??mero y regresa a leer caracteres
    cmp al,39h          
    jg lee_numero2      ;Si el valor ASCII de la tecla es mayor a 39h, no es n??mero y regresa a leer caracteres
